...
Partial Class Frm_ReportCustomer
    ...
    Private Sub InitializeComponent()
        ...
        ReportDataSource1.Name = "DSpelanggan"
        ReportDataSource1.Value = Me.PelangganBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "Reporting.Rpt_Customer.rdlc"
        ...
        '
        Me.PelangganBindingSource.DataSource = GetType(BPRoc_LIB.EntitiesModel.Pelanggan)
        '
        'Frm_ReportCustomer
        '
