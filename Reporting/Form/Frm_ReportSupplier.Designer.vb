...
Partial Class Frm_ReportSupplier
    ...
    Private Sub InitializeComponent()
        ...
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "Reporting.Rpt_Supplier.rdlc"
        ...
        '
        Me.SupplierBindingSource.DataSource = GetType(BPRoc_LIB.EntitiesModel.Supplier)
        '
        'Frm_ReportSupplier
        '
