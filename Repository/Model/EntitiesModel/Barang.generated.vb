...
Namespace EntitiesModel	
	...
	Public Partial Class Barang
		...
		Private _satuanDets As IList(Of SatuanDet)  = new List(Of SatuanDet)
		Public Overridable ReadOnly Property SatuanDets As IList(Of SatuanDet) 
			Get
		        Return Me._satuanDets
			End Get
		End Property
